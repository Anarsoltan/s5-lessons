...
from examples.stg.order_system_restaurants_dag.pg_saver import PgSaverRest
from examples.stg.order_system_restaurants_dag.pg_saver import PgSaverUsers
from examples.stg.order_system_restaurants_dag.pg_saver import PgSaverOrders
...
def sprint5_example_stg_order_system_restaurants():
    ...
    user_loader
    order_loader
order_dds_dag = sprint5_example_stg_order_system_restaurants()  # noqa
